...
parser = argparse.ArgumentParser(description='Burst Demosaicking and Denoising')
...
dataset = lmdbDataset('/home/filippos/data/MSR_burst_train_new_align.lmdb', transform=transforms.Compose(
    [RandomBurstHorizontalFlip(), RandomBurstVerticalFlip(), ToTensor()]))

dataloader_train = DataLoader(dataset, batch_size=args.batch_size, shuffle=True, pin_memory=True, num_workers=4)

dataset_val = lmdbDataset('/home/filippos/data/MSR_burst_val_new_align.lmdb',
...
try:
    ...
    for epoch in range(args.epochs):
        ...
        for i, sample in enumerate(dataloader_train):
            ...
            p = Burst_Demosaick_Denoise(image_input, mask, warp_matrix)
            if args.use_gpu:
            ...
            for i, sample in enumerate(dataloader_val):
                ...
                if args.save_images:
                    ...
                    for i_ in range(xcur.shape[0]):
                        ...
                        # plot.clf()
                del groundtruth, image_input, xcur, warp_matrix
...
dataset_test = lmdbDataset('/home/filippos/data/MSR_burst_test_new_align.lmdb',
                           transform=transforms.Compose([ToTensor()]))

datasets = [(dataset_test, 'MSR_burst')]
